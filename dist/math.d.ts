...
export declare const math: {
    ...
    vDist: (v1: number[], v2: number[]) => mathjs.Matrix;
    ...
    combinations: (a: number, b: number, c: number) => any[];
    combinationsFromIntervals: (arrA: number[], arrB: number[], arrC: number[]) => any[];
    calculateSegmentsBetweenPoints3D: (point1: (string | number)[], point2: (string | number)[], n: number | string) => any[];
    ...
    lup(A?: mathjs.MathArray | mathjs.Matrix): mathjs.MathArray;
    ...
    norm(x: number | mathjs.BigNumber | mathjs.Complex | mathjs.MathArray | mathjs.Matrix, p?: string | number | mathjs.BigNumber): number | mathjs.BigNumber;
    nthRoot(a: number | mathjs.BigNumber | mathjs.Complex | mathjs.MathArray | mathjs.Matrix, root?: number | mathjs.BigNumber): number | mathjs.Complex | mathjs.MathArray | mathjs.Matrix;
    ...
    bignumber(x?: string | number | boolean | mathjs.MathArray | mathjs.Matrix): mathjs.BigNumber;
    ...
    complex(arg?: string | mathjs.Complex | mathjs.MathArray | mathjs.PolarCoordinates): mathjs.Complex;
    complex(re: number, im: number): mathjs.Complex;
    fraction(numerator: string | number | mathjs.MathArray | mathjs.Matrix, denominator?: string | number | mathjs.MathArray | mathjs.Matrix): mathjs.Fraction | mathjs.MathArray | mathjs.Matrix;
    ...
    number(value?: string | number | boolean | mathjs.BigNumber | mathjs.Fraction | mathjs.Unit | mathjs.MathArray | mathjs.Matrix): number | mathjs.MathArray | mathjs.Matrix;
    ...
    resize(x: mathjs.MathArray | mathjs.Matrix, size: mathjs.MathArray | mathjs.Matrix, defaultValue?: string | number): mathjs.MathArray | mathjs.Matrix;
    ...
    format(value: any, options?: number | mathjs.FormatOptions | ((item: any) => string)): string;
