...
const includeSchema = js_yaml_1.default.DEFAULT_SCHEMA.extend([yaml_1.listToStringType]);
describe("YAML tag: !listToString", () => {
    const yamlFixture = fs_1.default.readFileSync(enums_1.YAML_LIST_TO_STRING_FILE, "utf8");
